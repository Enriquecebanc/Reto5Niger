...
async function verCategoria(id_categoria) {
    try {
        const response = await axios.get(`http://localhost:8000/cantidades/${id_categoria}`, {
            headers: {
...
const id_categoria = 89304768; // Reemplaza con el ID de la categoría que deseas obtener
